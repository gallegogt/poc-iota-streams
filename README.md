...
* [Simple Author](examples/e01-author.rs): Publish random data
...
* [Simple Subscriber](examples/e01-subscriber.rs): Fetch all message published by the Simple Author example
